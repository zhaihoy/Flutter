...
import '../weight/radius_img.dart';
import '../weight/video_widget.dart';
...
//    var resultList = result['subjects'];
  ...
  getContentSliver(BuildContext context, List<Subject> list) {
    ...
    print('getContentSliver${list.length}');
  ...
  getItemCenterImg(Subject item) {
    return Row(
      ...
      children: <Widget>[
        ...
        Expanded(
          child: RadiusImg.get(item.casts[1].avatars.medium, 0, radius: 0.0),
        ),
        Expanded(
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(IterableProperty('list', list));
  }
}
